const  askbVlK9qNzk = "aWfN3u0tpfgXfY13";//AESkey，可自定义
const  asiUCSgWE8mV = "blsKqi8BAPdGTG3i";//密钥偏移量IV，可自定义

const  ackygLFwKDEq = "dNN3qvXAvpyKO4YO";//AESkey，可自定义
const  acitqYhhNQts = "fbxrC2ZhNLbyf7n7";//密钥偏移量IV，可自定义

const  dskWe4RqyogN = "huRsEaYkornrBCHb";//DESkey，可自定义
const  dsiB8Bw1w9r4 = "xfqNBhgMShPXvIHM";//密钥偏移量IV，可自定义
...
function diTjQDU7BiX(pMzoHnC) {
    pMzoHnC = AES.decrypt(pMzoHnC, askbVlK9qNzk, asiUCSgWE8mV);
    return pMzoHnC;
}

function dtle2PqtJY(pMzoHnC) {
    pMzoHnC = DES.decrypt(pMzoHnC, dskWe4RqyogN, dsiB8Bw1w9r4);
    return pMzoHnC;
}

function gAvoZzCAYT5vY0sW(key, period) {
...
function dodjtLyJYEyYdF3W4(data) {
    data = BASE64.decrypt(data);
    data = DES.decrypt(data, dskWe4RqyogN, dsiB8Bw1w9r4);
    data = AES.decrypt(data, askbVlK9qNzk, asiUCSgWE8mV);
    data = BASE64.decrypt(data);
    return data;
}
var pLAyo1PaF = (function(){
    ...
    return function(mZX48o9v9, o7rwAP){
        var alLg = '03406fe70e9029fc164091072eb81c28';
        var cwQJk = 'WEB';
        var tcdX0xd = new Date().getTime();
        ...
        var pMzoHnC = {
            ...
            clienttype: cwQJk,
            object: o7rwAP,
            secret: hex_md5(alLg + mZX48o9v9 + tcdX0xd + cwQJk + JSON.stringify(osWpGLox7h(o7rwAP)))
        };
        pMzoHnC = BASE64.encrypt(JSON.stringify(pMzoHnC));
        pMzoHnC = AES.encrypt(pMzoHnC, ackygLFwKDEq, acitqYhhNQts);
        return pMzoHnC;
    };
})();
...
function main(mZX48o9v9, o7rwAP){
    var alLg = '03406fe70e9029fc164091072eb81c28';
    var cwQJk = 'WEB';
    var tcdX0xd = new Date().getTime();
...
function getData(data = {city: '上海', month: '201312'}){
    return main("GETDAYDATA",data)
}
function decrypt_result(data){
    return JSON.parse(dodjtLyJYEyYdF3W4(data))
}
console.log(getData())
/*const  ackygLFwKDEq = "dNN3qvXAvpyKO4YO";//AESkey，可自定义
const  acitqYhhNQts = "fbxrC2ZhNLbyf7n7";//密钥偏移量IV，可自定义
