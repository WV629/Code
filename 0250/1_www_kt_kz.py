...
class Spider(object):
    ...
    def parse(self,url):
        ...
        # 获取新闻列表
        divs = html.xpath("//ul[@class='news-list']/li")
        th = []
        for div in divs:
    ...
    def thread_parse(self,div):
        list1 = {}
        list1['标题'] = div.xpath(".//a[@class='news__overlay-link']/text()")[0].strip()
        list1['链接'] = urljoin(url,div.xpath(".//a[@class='news__overlay-link']/@href")[0])
        ...
        try:
            ...
            list1['浏览量'] = ''
        try:
            list1['图片地址'] = ''.join(detail_html.xpath("//div[@class='col-md-8']/div[1]/div[1]/picture/img/@src"))
        except:
            list1['图片地址'] = ''
        print(list1)
        datas.append(list1)
...
if __name__ == '__main__':
    ...
    spider = Spider()
    page = 86
    urls = [f'https://www.kt.kz/rus/search?page={i}&query=%D0%BA%D0%B8%D1%82%D0%B0%D0%B9' for i in range(1,page+1)]
    th = []
    for url in urls:
